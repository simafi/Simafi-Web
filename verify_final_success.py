#!/usr/bin/env python3
"""
Script para verificar el éxito final
"""
        ...
        if response.status_code == 200:
            ...
            if 'Información Básica' in content:
                ...
                if basic_info_start != -1:
                    ...
                    print(f"✅ IDNEG (valor válido) en sección básica: {idneg_correct}")
                    ...
                    if rtm_correct and expe_correct and idneg_correct:
                        ...
                        print("   - Los campos obligatorios tienen valores válidos")
                        print("   - La declaración se puede guardar correctamente")
                    else:
