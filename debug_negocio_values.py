#!/usr/bin/env python3
"""
Script para debuggear los valores del objeto negocio
"""

import requests

def debug_negocio_values():
    """Debuggear los valores del objeto negocio"""
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            if 'Negocio Actualizado - Prueba Final' in content:
                ...
                print("Esto sugiere que hay un problema con la búsqueda del negocio")
