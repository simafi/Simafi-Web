    ...
    try:
        ...
        if response.status_code == 200:
            ...
            for campo in campos_a_verificar:
                ...
                if matches:
                    print(f"   OK - Campo {campo}: {matches}")
                else:
            ...
            if form_match:
                print(f"   OK - Formulario encontrado: {form_match.group()}")
            else:
            ...
            if csrf_match:
                print(f"   OK - CSRF Token encontrado: {csrf_match.group(1)[:20]}...")
            else:
                print("   ERROR - CSRF Token NO encontrado")
