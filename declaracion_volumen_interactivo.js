...
class DeclaracionVolumenInteractivo {
            ...
            this.tarifasControlados = [
                {
                    ...
                    "valor": 0.5,
                    "categoria": "2",
                    "descripcion": "Rango $0 - $1,000,000 (Controlados)"
                },
                {
                    "rango1": 1000000.01,
                    "rango2": 5000000.0,
                    "valor": 0.6,
                    "categoria": "2",
                    "descripcion": "Rango $1,000,000 - $5,000,000 (Controlados)"
                },
                {
                    "rango1": 5000000.01,
                    "rango2": 10000000.0,
                    "valor": 0.7,
                    "categoria": "2",
                    "descripcion": "Rango $5,000,000 - $10,000,000 (Controlados)"
                },
                {
                    "rango1": 10000000.01,
                    "rango2": 20000000.0,
                    "valor": 0.8,
                    "categoria": "2",
                    "descripcion": "Rango $10,000,000 - $20,000,000 (Controlados)"
                },
                {
                    "rango1": 20000000.01,
                    "rango2": 30000000.0,
                    "valor": 0.9,
                    "categoria": "2",
                    "descripcion": "Rango $20,000,000 - $30,000,000 (Controlados)"
                },
                {
                    "rango1": 30000000.01,
                    "rango2": 9999999999.0,
                    "valor": 1.0,
                    "categoria": "2",
                    "descripcion": "Rango $30,000,000 - $9,999,999,999 (Controlados)"
                }
            ];
        }
    ...
    calcularEnTiempoReal(fieldName) {
        ...
        // PASO 3: Actualizar campo de impuesto total
        ...
        // PASO 5: Disparar evento personalizado
    ...
    obtenerValoresVentas() {
        // CORRECCIÓN: Incluir unidad y factor para que se sumen en productos controlados
        ...
        campos.forEach(campo => {
            ...
            if (valor > 0) {
                ...
                if (campo === 'ventas_produccion' || campo === 'rubro_produccion') {
                    ...
                    console.log(`✅ Campo controlado detectado con valor: ${valor}`);
    ...
    actualizarCamposCalculados(totalImpuesto, resultados) {
        ...
        if (campoImpuestoTabla) {
            ...
            console.log(`💰 Impuesto guardado en campo tabla 'declara': L. ${totalImpuesto.toFixed(2)}`);
        } else {
            ...
            for (const id of camposImpuesto) {
                ...
                if (campo) {
                    ...
                    campoActualizado = true;
                    console.log(`💰 Impuesto actualizado en ${id}: L. ${totalImpuesto.toFixed(2)}`);
                    break;
                }
            }
        }
        ...
        this.actualizarCampoIndividual('impuesto_controlados', resultados.controlados.impuestoTotal);
    }
    ...
    calcularYGuardarImpuestosIndependientes(valoresVentas) {
        ...
        // 4. Ventas Productos Controlados (controlado) - AQUÍ ESTÁ LA CORRECCIÓN PRINCIPAL
    ...
    /**
     * Suma los impuestos desde las variables ocultas - MÉTODO CORREGIDO PARA PRODUCTOS CONTROLADOS
     */
    sumarImpuestosDesdeVariablesOcultas() {
        ...
        console.log(`   Paso 5: ${(ventai + ventac + ventas + controlado).toFixed(2)} + ${unidadFactor.toFixed(2)} = ${totalImpuesto.toFixed(2)}`);
    ...
    actualizarCampoImpuesto(totalImpuesto) {
        ...
        if (campoImpuestoTabla) {
            ...
            for (const id of camposImpuesto) {
                ...
                if (campo) {
                    ...
                    campoActualizado = true;
                    console.log(`💰 Impuesto guardado en campo alternativo: ${id} = L. ${totalImpuesto.toFixed(2)}`);
                    break;
                }
            }
        }
        ...
        if (!campoActualizado) {
            console.warn('⚠️ No se pudo encontrar campo de impuesto para actualizar');
        }
    }
}
