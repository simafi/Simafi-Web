#!/usr/bin/env python3
"""
Test detallado para identificar el problema exacto que impide grabar
"""
...
def test_problema_grabar_detallado():
    """Test detallado para identificar el problema exacto que impide grabar"""
    ...
    try:
        ...
        print("=== TEST DETALLADO DEL PROBLEMA DE GRABADO ===")
        ...
        if response.status_code == 200:
            ...
            if csrf_match:
                ...
                # Test 1: Formulario con datos mínimos válidos
                print("\n2. Test 1: Formulario con datos mínimos válidos")
                form_data_minimo = {
                    ...
                    'tipo': '1',
                    'mes': '1',
                    'ventai': '1000.00',  # Solo un campo de ventas
                    'ventac': '0.00',
                    'ventas': '0.00',
                    'valorexcento': '0.00',
                    'controlado': '0.00',
                ...
                # Test 2: Formulario con datos completos
                print("\n3. Test 2: Formulario con datos completos")
                form_data_completo = {
                    'csrfmiddlewaretoken': csrf_value,
                    'accion': 'guardar',
                    'idneg': '15',
                ...
                post_response2 = session.post(url, data=form_data_completo, timeout=10)
                ...
                # Test 3: Formulario con datos inválidos (para probar validación)
                print("\n4. Test 3: Formulario con datos inválidos")
                form_data_invalido = {
                    'csrfmiddlewaretoken': csrf_value,
                    'accion': 'guardar',
                    'idneg': '15',
                ...
                post_response3 = session.post(url, data=form_data_invalido, timeout=10)
                ...
                if post_response3.status_code == 200:
                    ...
                    if "Al menos uno de los campos de ventas debe tener un valor mayor a 0" in post_response3.text:
                        ...
                        print("   WARNING - No se encontró mensaje de validación")
                ...
                print("2. Si se encuentran mensajes de error específicos, el problema está en la lógica de negocio")
                print("3. Si no se encuentran mensajes de error, el problema podría estar en el frontend (JavaScript)")
                print("4. Si se encuentran mensajes de validación, el problema está en las reglas de validación")
...
if __name__ == "__main__":
    test_problema_grabar_detallado()
