#!/usr/bin/env python
"""
Script para probar con los datos exactos que envía el navegador
"""
...
def test_exact_ajax():
    ...
    # Datos exactos como los envía el navegador
    datos = {
        'accion': 'guardar',
        'form_data': {
            'idneg': '0301',
    ...
    print(f"\n2. Enviando petición AJAX con datos exactos...")
    print(f"   - URL: {url}")
