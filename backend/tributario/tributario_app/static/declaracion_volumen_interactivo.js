...
class DeclaracionVolumenInteractivo {
    ...
    actualizarCamposCalculados(totalImpuesto, resultados) {
        ...
        if (campoImpuestoTabla) {
            ...
            const valorFormateado = totalImpuesto.toLocaleString('es-HN', {
                minimumFractionDigits: 2,
                maximumFractionDigits: 2
            });
            campoImpuestoTabla.value = valorFormateado;
            ...
            console.log(`💰 Impuesto guardado en campo tabla 'declara': $${valorFormateado}`);
        } else {
            ...
            for (const id of camposImpuesto) {
                ...
                if (campo) {
                    ...
                    campoActualizado = true;
                    console.log(`💰 Impuesto actualizado en ${id}: $${valorFormateado}`);
                    break;
                }
            }
        }
