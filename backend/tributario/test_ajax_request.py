#!/usr/bin/env python
"""
Script para probar una petición AJAX al endpoint de declaracion_volumen
"""
...
def test_ajax_request():
    print("="*80)
    print("PROBANDO PETICION AJAX A DECLARACION VOLUMEN")
    print("="*80)
    ...
    print(f"\n2. Enviando petición AJAX a: {url}")
    ...
    try:
        ...
        return response.status_code == 200 and 'application/json' in content_type
