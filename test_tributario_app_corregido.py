#!/usr/bin/env python
"""
Test corregido para tributario_app con campo empresa (no municipio_codigo)
"""
...
def test_tributario_app_credenciales():
    """Test de credenciales en tributario_app con campo empresa"""
    ...
    try:
        ...
        # 5. Verificar asociación usuario-empresa (equivalente a municipio)
        print("\n5. Verificando asociación usuario-empresa...")
        if user.empresa == municipio.codigo:
            print("   ✅ Usuario asociado a la empresa correcta")
            empresa_correcta = True
        else:
            print(f"   ❌ Usuario asociado a empresa {user.empresa}, esperado {municipio.codigo}")
            empresa_correcta = False
        ...
        resultados = [
            ...
            ("Asociación usuario-empresa", empresa_correcta)
        ]
...
def main():
    ...
    print("Campo: empresa (no municipio_codigo)")
    print("=" * 60)
