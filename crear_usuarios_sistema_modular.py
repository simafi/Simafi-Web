        ...
        with connection.cursor() as cursor:
            for user_data in usuarios:
                ...
                cursor.execute("""
                    ...
                    WHERE codigo = %s
                """, [user_data['municipio_codigo']])
                
                municipio_result = cursor.fetchone()
                if not municipio_result:
                    print(f"❌ Municipio {user_data['municipio_codigo']} no encontrado")
                    continue
                ...
                if existing_user:
                    ...
                    cursor.execute("""
                        ...
                        (empresa, usuario, nombre, password, municipio_id, is_active, created_at, updated_at)
